...
export const semantic = {
  ...
  text:         neutrals[900],
  textSecondary: neutrals[500],
  textTertiary: neutrals[400],
  textInverse:  '#FFFFFF',

  primary:      accents.blue[500],
  primaryHover: accents.blue[600],
  primaryLight: accents.blue[100],
  primaryText:  '#FFFFFF',

  success:      accents.green[500],
  successLight: accents.green[100],
  warning:      accents.yellow[500],
  warningLight: accents.yellow[100],
  danger:       accents.red[500],
  dangerHover:  accents.red[600],
  dangerLight:  accents.red[100],

  focus:        accents.blue[400],
...
export const darkSemantic = {
  ...
  primary:      accents.blue[400],
  primaryHover: accents.blue[300],
  primaryLight: accents.blue[900],
  primaryText:  neutrals[950],

  success:      accents.green[400],
  successLight: accents.green[900],
  warning:      accents.yellow[400],
  warningLight: accents.yellow[900],
  danger:       accents.red[400],
  dangerHover:  accents.red[300],
