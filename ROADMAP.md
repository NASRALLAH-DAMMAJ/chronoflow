...
| GitHub issues cleanup (20 issues) | 10/20 closed |
...
| # | Task | Issue | Status |
|---|------|-------|--------|
| 0.4.1 | Fix innerR mismatch (hit detection 0.6 vs render 0.55) | [#1](https://github.com/NASRALLAH-DAMMAJ/chronoflow/issues/1) | Done |
| 0.4.2 | Move side effect out of reducer (COMPLETE_DAY) | [#2](https://github.com/NASRALLAH-DAMMAJ/chronoflow/issues/2) | Done |
| 0.4.3 | Fix block ID collision risk (use crypto.randomUUID) | [#3](https://github.com/NASRALLAH-DAMMAJ/chronoflow/issues/3) | Done |
| 0.4.4 | Add focus indicators + keyboard support to inputs | [#4](https://github.com/NASRALLAH-DAMMAJ/chronoflow/issues/4) | Not started |
| 0.4.5 | Add aria-label to all icon-only buttons | [#5](https://github.com/NASRALLAH-DAMMAJ/chronoflow/issues/5) | Done |
| 0.4.6 | Add focus trap to Modal and Onboarding | [#6](https://github.com/NASRALLAH-DAMMAJ/chronoflow/issues/6) | Not started |
| 0.4.7 | Add ARIA role/label to canvas | [#7](https://github.com/NASRALLAH-DAMMAJ/chronoflow/issues/7) | Done |
| 0.4.8 | Add ARIA slider attributes to TimeBar | [#8](https://github.com/NASRALLAH-DAMMAJ/chronoflow/issues/8) | Done |
| 0.4.9 | Fix theme inconsistencies (overlay, TimeBar handle) | [#9](https://github.com/NASRALLAH-DAMMAJ/chronoflow/issues/9) | Not started |
| 0.4.10 | Replace var with const/let in DialCanvas.js | [#10](https://github.com/NASRALLAH-DAMMAJ/chronoflow/issues/10) | Done |
| 0.4.11 | Extract duplicate utilities to shared modules | [#11](https://github.com/NASRALLAH-DAMMAJ/chronoflow/issues/11) | Not started |
| 0.4.12 | Remove dead files and unused exports | [#12](https://github.com/NASRALLAH-DAMMAJ/chronoflow/issues/12) | Done |
| 0.4.13 | Memoize Context value in StoreContext | [#13](https://github.com/NASRALLAH-DAMMAJ/chronoflow/issues/13) | Done |
| 0.4.14 | Remove unused CSS custom properties | [#14](https://github.com/NASRALLAH-DAMMAJ/chronoflow/issues/14) | Not started |
| 0.4.15 | Remove dead snapEnabled prop | [#15](https://github.com/NASRALLAH-DAMMAJ/chronoflow/issues/15) | Done |
| 0.4.16 | Fix category color contrast on dark backgrounds | [#16](https://github.com/NASRALLAH-DAMMAJ/chronoflow/issues/16) | Not started |
| 0.4.17 | Add vitest + test suite | [#17](https://github.com/NASRALLAH-DAMMAJ/chronoflow/issues/17) | Not started |
| 0.4.18 | Add ESLint, Prettier, editorconfig | [#18](https://github.com/NASRALLAH-DAMMAJ/chronoflow/issues/18) | Not started |
| 0.4.19 | Add missing responsive styles for mobile | [#19](https://github.com/NASRALLAH-DAMMAJ/chronoflow/issues/19) | Not started |
| 0.4.20 | Cache getComputedStyle on canvas draw | [#20](https://github.com/NASRALLAH-DAMMAJ/chronoflow/issues/20) | Not started |
...
| 0.4 GitHub issues cleanup | 10 | 20 | ~4h | In progress |
